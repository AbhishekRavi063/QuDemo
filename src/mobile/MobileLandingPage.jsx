...
const MobileLandingPage = () => {
  ...
  // AUTH + DASHBOARD BUTTONS REMOVED FOR NOW
      ...
      >
        {/* Hero Section */}
        <FadeInSection delay={0} className="flex flex-col z-[999]" disableAnimation={true}>
          <div
        ...
        <FadeInSection delay={0.1} className="flex flex-col relative" disableAnimation={true}>
          <div
            className={`w-full h- relative overflow-hidden z-50 ${''}`}
            style={{
              backdropFilter: "none",
            }}
          >
        ...
        // Quote Section */}
        {/*
        <FadeInSection delay={0.1} className="flex flex-col !min-h-0 relative" disableAnimation={true}>
          <div
            className="absolute top-0 -translate-y-1/2 left-0 right-0 h-px hidden md:block"
            style={{
              background:
...
*/}
        ...
        {false && (
        <FadeInSection delay={0.1} className="relative" disableAnimation={true}>
...
*/}
        ...
        */}
        ...
        <FadeInSection delay={0.1} className="min-h-[40vh]" disableAnimation={true}>
