...
import {
  getVideoType,
  canPlayWithCustomPlayer,
} from "../utils/videoUrlProcessor";
...
const HybridVideoPlayer = ({
  ...
  return (
    ...
    >
      {/* Audio Toggle Button */}
      <button
        className="absolute top-4 left-4 bg-white text-gray-900 hover:text-blue-500 rounded-full p-2 border z-10"
        onClick={(e) => {
          e.stopPropagation();
          enableAudio();
        }}
