...
const DemoHomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        <div>
          ...
          <p className="mt-4 text-gray-600 text-lg">
            Our AI-powered platform helps businesses automate customer
            interactions, boost engagement, and drive growth through
          ...
          <div className="mt-6 flex gap-4 relative">
            ...
            {showHeroDropdown && (
              <div className="absolute left-0 top-full mt-2 w-56 bg-white shadow-lg rounded-lg text-sm text-gray-800 z-10">
                <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-8 relative">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Select a convenient time for a personalized demo with one of our
              product specialists.
            </p>
      ...
      {showInteractiveDemoPopup && (
        <InteractiveDemoPopup onClose={closeInteractivePopup} />
      )}
      ...
      <section className="py-16 bg-gray-50 text-center bg-white">
        ...
        <div className="flex justify-center flex-wrap gap-40 text-gray-500 text-lg font-medium">
          <span>ACME Corp</span>
      ...
      <section className="py-20 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto px-6 text-left">
          <BenefitItem
