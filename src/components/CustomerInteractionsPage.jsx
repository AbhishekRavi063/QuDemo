...
const CustomerInteractionsPage = () => {
  ...
  return (
    <div className="space-y-6">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedInteractions.length === 0 ? (
                ...
                paginatedInteractions.map((interaction, index) => (
                  <tr key={interaction.share_id || index} className="hover:bg-whiter">
      ...
      {/* Pagination */}
      {totalPages > 1 && (
        <div className="flex items-center justify-between border-t border-strokedark/10 bg-white px-4 py-3 sm:px-6">
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <div>
              <nav className="isolate inline-flex -space-x-px rounded-md shadow-none" aria-label="Pagination">
                <button
                  onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                  disabled={currentPage === 1}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                      ...
                      <div className="bg-white border border-strokedark/10 rounded-lg p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-bodydark">Demo Watched</p>
                            <p className="text-lg font-semibold text-graydark">{selectedInteraction.qudemo_title || 'Unknown Demo'}</p>
                          </div>
                        </div>
                      </div>
                      {/* Time Spent */}
                      <div className="bg-white border border-strokedark/10 rounded-lg p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-bodydark">Time Spent</p>
                            <p className="text-lg font-semibold text-graydark">{formatDuration(selectedInteraction.total_duration)}</p>
                          </div>
                        </div>
                      </div>
                      {/* Questions Asked */}
                      <div className="bg-white border border-strokedark/10 rounded-lg p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-bodydark">Questions Asked</p>
                            <p className="text-lg font-semibold text-graydark">{selectedInteraction.question_count || 0}</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-graydark text-left">Upgrade Required</h3>
            </div>
