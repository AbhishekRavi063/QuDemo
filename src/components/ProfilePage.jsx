            ...
            <form>
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="inline-flex justify-center items-center h-12 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={isSavingProfile}
                  className="inline-flex justify-center items-center h-12 px-4 border border-strokedark/20 shadow-sm text-sm font-medium rounded-md text-bodydark bg-white hover:bg-whiter focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
              </div>
